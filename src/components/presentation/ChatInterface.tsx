...
import { Send, Paperclip, Image as ImageIcon, Phone, Video, MoreVertical, ArrowLeft, User } from 'lucide-react';
...
interface ChatInterfaceProps {
  ...
  messages: Message[];
  onBack: () => void;
  currentUserType?: 'patient' | 'doctor' | null;
}
    ...
    <div className="flex flex-col h-full bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => {
          ...
          >
            <div className={`max-w-[70%] ${isOwnMessage ? 'bg-primary text-white' : 'bg-gray-100 text-gray-900'} rounded-2xl px-4 py-2`}>
              <p>{message.content}</p>
